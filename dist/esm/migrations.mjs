...
const migrationList = [
    new MigrationOperation('migrateScopeFieldToVarchar1024', migrateScopeFieldToVarchar1024),
...
export { migrateScopeFieldToVarchar1024, migrateToCaseSensitivity, migrationList };
